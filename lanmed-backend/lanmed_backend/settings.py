...
ROOT_URLCONF = 'lanmed_backend.urls'
...
WSGI_APPLICATION = 'lanmed_backend.wsgi.application'

DATABASES = {
    'default': dj_database_url.config(
        default=os.environ.get('DATABASE_URL', 'postgres://postgres:postgres@localhost:5432/lanmed'),
        conn_max_age=600,
